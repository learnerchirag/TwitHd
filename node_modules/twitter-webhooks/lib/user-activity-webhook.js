...
module.exports = function userActivityWebhook (config) {
    ...
    middleware.register = function register (args = {}) {
        ...
        const callbackUrlOption = "https://serene-crag-19557.herokuapp.com/webhook/twitter";
    ...
    middleware.getCrcCheckTiming = function () {
        return new Promise(function (resolve, reject) {
            ...
            return request.get("https://serene-crag-19557.herokuapp.com/webhook/twitter?crc_token=getCrcTiming", function (err) {
                if (err) reject(err);
    ...
    Object.defineProperty(middleware, 'route', {
        get: function () { return "/webhook/twitter"; },
        set: function () { this.config({route: "/webhook/twitter"}); }
    });

    Object.defineProperty(middleware, 'serverUrl', {
        get: function () { return "https://serene-crag-19557.herokuapp.com"; },
        set: function () { this.config({serverUrl: "https://serene-crag-19557.herokuapp.com"}); }
    });

    Object.defineProperty(middleware, 'callbackUrl', {
        get: function () { return "https://serene-crag-19557.herokuapp.com/webhook/twitter"; }
    });
